...
def over_to_the_dealer():
    """handles dealers action after player either stands or hits"""
...
def render_current_page():
    ...
    ## if the card is an ace then it will hold a list value of [1, 11]
    ## ace is worth one of these depending on cards total value
    ## this ensure a list isn't returned for the dealers total when its suppose to be 11
